	       ...
	       <div class="contact-info">
	           <h2 class="title">Contact Info</h2>
	               <address>
				    ...
				    <p>Bangalore</p>
				    <p>India</p>
				    <p>Phone:(+91) 9620502530</p>
				    <p>Fax:(0816) 222 55 33 6</p>
				    <p>Email: razer124@gmail.com</p>
	               </address>
	               
	            <div><h2 class="title">Follow Us On&#58;</h2>
                   <a href="https://www.facebook.com/prajwal.n0thing/" target="_blank"><img src="./img/logofb.png" alt="fb logo" style="width:30px; height:30px; border:0"></a>
                   <a href="https://twitter.com/prajwaln11" target="_blank"><img src="./img/logotwitter.png" alt="twitter logo" style="width:30px; height:30px; border:0; padding-left:10px;"></a>
               </div>
            </div>
        </div>
    </div>
